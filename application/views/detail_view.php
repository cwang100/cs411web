...
<div class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <br></br>
            <p>The seller is <strong><?php if($seller_status == 1) { echo 'Online'; ?></strong>!</p>
            <p> Click <a href="javascript:void(0)" onClick="javascript:chat_with('<?php echo $item_detail->ownername ?>');">here</a> to have live chat </p> 
            <?php } elseif($seller_status == 0) { echo 'Offline'; ?></strong><?php } elseif($seller_status == 2) { echo 'yourself';}?>!</p>
        </div>
