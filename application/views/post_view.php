          ...
          <div class="col-lg-8">
            <div class="ui-select">
              <select id="gender" class="form-control" name="gender">
                <option value="female" <?php if($edit) { if($item_detail->gender == "female") echo "selected";} ?> >Women</option>
                <option value="male" <?php if($edit) { if($item_detail->gender == "male") echo "selected";} ?> >Man</option>
              </select>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-8">
            <div class="ui-select">
              <select id="clothes-style" class="form-control" name="type" value="<?php echo set_value('type');?>">
                <option value="top"<?php if($edit) { if($item_detail->type == "top") echo "selected";} ?> >Top</option>
                <option value="bottom"<?php if($edit) { if($item_detail->type == "bottom") echo "selected";} ?> >Bottom</option>
                <option value="shoes"<?php if($edit) { if($item_detail->type == "shoes") echo "selected";} ?> >Shoes</option>
              </select>
            </div>
          </div>
        </div>
